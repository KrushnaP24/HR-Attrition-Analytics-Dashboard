...
The objective is to identify the key drivers of attrition and provide **actionable, data-driven insights** to improve employee retention and workforce planning.
...
- **Operations (17.43%)** and **HR (16.93%)** departments show the highest attrition.
...
- Strengthen **succession planning** for the senior workforce.
...
## 📷 Dashboard Preview
![Dashboard Screenshot](HR_Attrition_Dashboard.png)
